...
// @grant        none
// @updateURL    https://imagesync.org/mobile/builds/NameSync.mobile.meta.js
// @downloadURL  https://imagesync.org/mobile/builds/NameSync.mobile.user.js
  ...
  */
  ...
  Sync = {
    sync: function () {
      ...
      $.xhr('GET', 'https://imagesync.org/namesync/qp.php', $GET, function (c) {
        if (c.responseText !== '') {
    ...
    post: function (name, subject, email, thread, no) {
      ...
      $.xhr('POST', 'https://imagesync.org/namesync/sp.php', $POST, function (c) {
    ...
    checkUpdate: function () {
      if (!g.checked) {
        ...
        $.xhr('GET', 'https://imagesync.org/mobile/v.php', null, function (c) {
          var v;
          v = $.JSON(c.responseText)['VERSION'];
          if (g.VERSION !== v) {
            $HTML = '<span style="color: red; font-weight: bold;">New Version Available:</span> <a href="https://imagesync.org/mobile/" style="font-weight: bold;">Here</a>';
